// pages/index.js
// WomanCart Shopping Persona Generator - Nykaa-inspired design with 3D Pixar avatars

import React, { useState, useRef } from 'react';

export default function WomanCartPersonaGenerator() {
  ...
  const handleGenerate = async () => {
    if (!formData.cartBehavior || !formData.paymentStyle || !formData.shoppingSpeed) {
      setError('Please answer all questions to discover your persona!');
      return;
    }
    ...
    try {
      const response = await fetch('/api/generate-persona', {
        ...
        body: JSON.stringify({
          ...
          photo: formData.photo || 'placeholder'
        })
      });
  ...
  const generateIDCard = (data) => {
    ...
    ctx.fillText('✨ WOMANCART SHOPPING PERSONA ✨', width / 2, 60);

    ctx.font = 'bold 38px Arial, sans-serif';
    ctx.fillStyle = '#FFD700';
    ctx.fillText(data.personaTitle, width / 2, 115);
    ...
    details.forEach((detail, i) => {
      ctx.fillText(detail, 300, 195 + (i * 35));
    });
    ...
    ctx.textAlign = 'right';
    ctx.fillText(`ID: WC-${Date.now().toString(36).toUpperCase()}`, width - 40, height - 30);
  };

  const downloadCard = () => {
    const canvas = canvasRef.current;
    const link = document.createElement('a');
    link.download = `WomanCart-${result.personaTitle.replace(/\s/g, '-')}-ID.png`;
        ...
        <div style={styles.container}>
          ...
          <div style={styles.promoBanner}>
            <div style={styles.promoContent}>
              ...
              <span style={styles.promoText}>Discover Your 3D Pixar-Style Shopping Persona & Get Your AI-Generated Avatar!</span>
              <span style={styles.promoIcon}>✨</span>
            </div>
          </div>
          ...
          <div style={styles.hero}>
            <h1 style={styles.heroTitle}>Discover Your Shopping Persona</h1>
            <p style={styles.heroSubtitle}>Get your AI-generated 3D Pixar-style avatar & personalized ID card!</p>
          </div>
            ...
            <div style={styles.quizCard}>
              ...
              <div style={styles.infoBox}>
                ...
                <p style={styles.infoText}>
                  We'll create a unique 3D Pixar-style avatar based on your answers! 
                  Your AI-generated character will be customized to match your shopping persona.
                </p>
              </div>
    ...
    return (
      <div style={styles.loadingContainer}>
        <div style={styles.loadingCard}>
          ...
          <h2 style={styles.loadingTitle}>Creating Your 3D Pixar Avatar...</h2>
          <p style={styles.loadingText}>🎨 Analyzing your shopping personality</p>
          <p style={styles.loadingText}>✨ Generating your unique 3D character</p>
          <p style={styles.loadingText}>🎬 Rendering Pixar-quality details</p>
          <p style={styles.loadingText}>💫 Finalizing your exclusive ID card</p>
          <p style={styles.loadingSubtext}>(This may take 15-20 seconds for HD quality)</p>
        </div>
      </div>
    );
  }
    ...
    <div style={styles.container}>
      ...
      <div style={styles.resultContainer}>
        <div style={styles.resultCard}>
          <h1 style={styles.resultTitle}>Your 3D Pixar Persona Revealed! 🎉</h1>
          <p style={styles.resultSubtitle}>Meet your AI-generated shopping avatar</p>
          ...
          <div style={styles.shareSection}>
            <p style={styles.shareTitle}>Love your 3D avatar? Share it with friends!</p>
          ...
          <div style={styles.aiNotice}>
            <p style={styles.aiNoticeText}>
              ✨ Your avatar was created using AI (DALL-E 3) with professional 3D Pixar-style rendering
            </p>
          </div>
        </div>
      </div>
...
const styles = {
  ...
  infoBox: {
    background: 'linear-gradient(135deg, #E91E6310, #FC518510)',
